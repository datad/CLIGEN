...
readBRCAFiles <- function(dataFile = "temp/old_moved_10-10/1-2v3data.RData", 
                      rawMutationFile="/Users/diamac/10-Research/4Current/CLINGEN/12Datasets/BRCA/brca4mCBioportal/data_mutations_extended.txt",
                      rawClinicalFile="/Users/diamac/10-Research/4Current/CLINGEN/12Datasets/BRCA/gdacLevel_1/BRCA.clin.merged.txt"){
...
#' 
filterClinicalVariables <- function(mergeClinical=T){
  ...
  if(mergeClinical){
    ...
    tensorClinical <- useClini
    save(tensorClinical, file="data/tensorClinical.RData")
  }
  
  

  save.image(file = "temp/filterCLinicalVariables.RData")
}
